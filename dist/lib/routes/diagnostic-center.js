...
router.post("/register", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const doc = yield new DiagnosticCenter(diagnosticCenter).save();
...
router.get("/search", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const testIds = yield testService.findByName(testName);
        const centers = yield DiagnosticCenter.find({ tests: { $all: testIds } });
        if (centers.length > 0) {
            res.status(200).json(centers);
        }
        else {
...
router.get("/show-near-centers", checkForAuth, (req, res, next) => {
    ...
    userService.findUserById(req.userId).then((user) => {
